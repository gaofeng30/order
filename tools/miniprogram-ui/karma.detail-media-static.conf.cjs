...
module.exports = function configure(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'tools/miniprogram-ui/test/browser/ui1-detail-media-static.spec.cjs',
    ],
    preprocessors: {
      'tools/miniprogram-ui/test/browser/ui1-detail-media-static.spec.cjs': ['webpack'],
    },
    webpack: { mode: 'development', devtool: false, module: { rules: [{ test: /\.wxml$/, type: 'asset/source' }] } },
    reporters: ['progress'],
    browsers: ['OrderDetailMediaChromiumHeadless'],
    customLaunchers: {
      OrderDetailMediaChromiumHeadless: {
        base: 'ChromeHeadless',
