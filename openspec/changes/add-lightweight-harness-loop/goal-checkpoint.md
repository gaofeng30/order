...
- `C9/T10/V8/R9=36`; hard blockers `0` after the focused source-worktree repair.
- Main and sibling checkouts now resolve the writer-owned active change only after verifying absolute real path, exact Git common dir, recorded branch and change directory; missing or foreign sources fail closed.
- Final base diff still excludes root governance and every protected Skill; replacement candidate SHA will be bound externally after the immutable commit.
